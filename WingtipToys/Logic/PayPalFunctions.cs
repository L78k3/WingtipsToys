...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-vkain326712_api1.personal.example.com";
    private string APIPassword = "6TMJWJQ9AWJ2SETR";
    private string APISignature = "AujTvHNHq3fCgLKJNH3XnSe2GJIRALxuVNR23htYrD6ftsY0VtLmyBeJ";
   ...
   retMsg)
    {
        ...
        string returnURL = "http://localhost:44300/Checkout/CheckoutReview.aspx";
